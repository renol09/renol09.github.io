                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-10 mb-2">
                            <select name="jurusan" id="jurusan" class="form-select">
                                ...
                                <option <?= ($row['jurusan'] == "Teknik Informatika") ? "selected" : "" ?> 
                                >Teknik Informatika</option>
                                <option <?= ($row['jurusan'] == "Sistem Informasi") ? "selected" : "" ?> 
                                >Sistem Informasi</option>
                                <option <?= ($row['jurusan'] == "Bisnis Digital") ? "selected" : "" ?> 
                                >Bisnis Digital</option>
                                <option <?= ($row['jurusan'] == "Desain Komunikasi Visual") ? "selected" : "" ?> 
